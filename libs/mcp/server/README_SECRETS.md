...
- **Location**: `.stakpak.session.secrets`
...
**Session file (`.stakpak.session.secrets`):**
...
1. **Session file protection**: Ensure `.stakpak.session.secrets` has appropriate permissions
